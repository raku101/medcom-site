...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-right">
            <h2 class="text-2xl font-bold text-[#1a5a72] mb-6">استخدامات الأنظمة الصوتية الذكية في الأماكن التجارية</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                <div class="bg-[#f8fafc] p-6 rounded-lg border-r-4 border-[#1a9ba4]">
                    <h3 class="text-xl font-bold text-[#1a5a72] mb-3">مميزات النظام</h3>
                ...
                <div class="bg-[#f8fafc] p-6 rounded-lg border-r-4 border-[#1a9ba4]">
                    <h3 class="text-xl font-bold text-[#1a5a72] mb-3">تطبيقات عملية</h3>
                    <ul class="list-disc pr-5 space-y-2 text-gray-700">
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div class="md:w-1/2 text-right">
                <h2 class="text-2xl font-bold text-[#1a5a72] mb-4">نظام الصوت الذكي للمنازل</h2>
                <p class="text-gray-700 mb-4">
                    نظام المنزل الذكي هو أكثر من مجرد مجموعة من الأجهزة؛ المصممة بسلاسة لتعزيز كل جانب من جوانب حياتك. فهو شبكة من الأجهزة المترابطة، التي تتم أتمتتها لتوقع احتياجاتك والتكيف معها.
                </p>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-[#1a5a72] mb-3">مكونات الأنظمة الصوتية الذكية</h2>
            <div class="w-24 h-1 bg-[#1ac8a4] mx-auto"></div>
        </div>
        
        <div class="grid md:grid-cols-3 gap-6">
            <!-- Component 1 -->
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div class="bg-[#1a5a72] text-white p-4 text-center">
                    ...
                    <h3 class="text-xl font-bold">مكبرات صوت ذكية</h3>
                </div>
                <div class="p-6 text-right">
                    <p class="text-gray-700">
                        مكبرات صوت عالية الجودة قابلة للتخصيص حسب احتياجات المساحة، مع إمكانية التحكم عن بعد.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div class="bg-[#1a5a72] text-white p-4 text-center">
                    ...
                    <h3 class="text-xl font-bold">أنظمة التحكم</h3>
                </div>
                <div class="p-6 text-right">
                    <p class="text-gray-700">
                        وحدات تحكم مركزية ولوحات تحكم لمسية تمكنك من إدارة النظام الصوتي بكامل مرونته.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div class="bg-[#1a5a72] text-white p-4 text-center">
                    ...
                    <h3 class="text-xl font-bold">التكامل الذكي</h3>
                </div>
                <div class="p-6 text-right">
                    <p class="text-gray-700">
                        تكامل كامل مع أنظمة المنزل الذكي والمساعدات الصوتية مثل Google Assistant وAmazon Alexa.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-[#1a5a72] mb-6">تجربة سمعية غامرة لم يسبق لها مثيل</h2>
            <p class="text-lg text-gray-700 mb-8 leading-relaxed">
                صوتياتك المفضلة، حيث تنسجم التكنولوجيا المتطورة مع محيطك لتقدم لك تجربة سمعية استثنائية. سواء كنت صاحب عمل يسعى لتحسين مساحة العمل الخاصة به، أو تبحث عن نظام صوتي متكامل لمنزلك، فإن هذه الأنظمة توفر لك مجموعة كبيرة من المزايا التي تلبي احتياجاتك وتفضيلاتك المتنوعة.
            </p>
            
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <h3 class="text-xl font-bold text-[#1a5a72] mb-4">للأعمال التجارية</h3>
                    <p class="text-gray-700">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <h3 class="text-xl font-bold text-[#1a5a72] mb-4">للمنازل الذكية</h3>
                    <p class="text-gray-700">
