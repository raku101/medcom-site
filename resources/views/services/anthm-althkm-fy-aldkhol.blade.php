...
<section class="relative py-20 text-white overflow-hidden dark:bg-[#0f172a]">
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/access-control-bg.jpg') }}" alt="خلفية صفحة أنظمة التحكم في الدخول" 
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">أجهزة التحكم في الأبواب المنزلية والفيلات</h3>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">بوابات دخول الأفراد</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">بوابات تفتيش الحقائب والمعادن</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">أجهزة الأقفال الذكية</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">حواجز مواقف السيارات</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">بوابات أمنية بكاميرات ذكاء اصطناعي</h3>
                <p class="text-gray-600 dark:text-gray-300">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">أنظمة دخول باستخدام QR أو NFC</h3>
                    <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">تقارير دخول وخروج متزامنة</h3>
                    <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">تكامل مع أنظمة الإنذار والمراقبة</h3>
                    <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">إدارة الصلاحيات المركزية</h3>
                    <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">تحكم عن بعد</h3>
                    <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">إنذارات فورية</h3>
                    <p class="text-gray-600 dark:text-gray-300">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">تقنيات متطورة</h3>
                <p class="text-gray-600 dark:text-gray-300">
