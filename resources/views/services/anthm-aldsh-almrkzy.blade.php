    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600">تصميم وتنفيذ شبكات دش مركزي</h3>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600">توزيع إشارة رقمية وHD</h3>
                <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600">دعم فني وصيانة دورية</h3>
                <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600">تكامل مع أنظمة IPTV</h3>
                <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600">تمديد الكوابل والتوزيع</h3>
                <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600">أجهزة استقبال مركزية</h3>
                <p class="text-gray-600 dark:text-gray-500">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-600">أنظمة بدون أطباق ظاهرية</h3>
                    <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-600">حزم قنوات حسب الطلب</h3>
                    <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-600">تحكم عن بعد بالتطبيقات</h3>
                    <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-600">أنظمة متعددة الأقمار</h3>
                    <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-600">حلول للفنادق والمجمعات</h3>
                    <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-600">ترقيات مستقبلية</h3>
                    <p class="text-gray-600 dark:text-gray-500">
