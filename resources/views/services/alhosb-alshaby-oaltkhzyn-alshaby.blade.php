...
<section class="relative py-20 text-white overflow-hidden dark:bg-[#0f172a]">
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/cloud-bg.jpg') }}" alt="خلفية صفحة الحوسبة السحابية" 
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">نقل البيانات والنسخ الاحتياطي</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">أنظمة البريد الإلكتروني الاحترافية</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">حلول العمل عن بُعد الآمنة</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">أنظمة إدارة قواعد البيانات</h3>
                <p class="text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-white">مراقبة الأداء والأمان</h3>
                <p class="text-gray-600 dark:text-gray-300">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-white">أداء فائق</h3>
                <p class="text-gray-600 dark:text-gray-300">
