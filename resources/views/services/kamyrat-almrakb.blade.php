        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-50 dark:bg-slate-700 rounded-lg overflow-hidden shadow-md border border-gray-200 dark:border-slate-600">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 mb-4">
                        نظام متكامل يشمل تركيب الكاميرات في المواقع الاستراتيجية لضمان الأمن وكفاءة المراقبة.
                    </p>
                    <ul class="list-disc pr-5 space-y-1 text-gray-600 dark:text-gray-300">
            ...
            <div class="bg-gray-50 dark:bg-slate-700 rounded-lg overflow-hidden shadow-md border border-gray-200 dark:border-slate-600">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 mb-4">
                        مصمم لتوفير الأمن والراحة في المنزل، مع تحديد الأماكن الأساسية التي تحتاج إلى مراقبة.
                    </p>
                    <ul class="list-disc pr-5 space-y-1 text-gray-600 dark:text-gray-300">
