    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 "> الحماية الأساسية للأجهزة</h3>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 "> الحماية المتقدمة لنقاط النهاية</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 "> الحماية بإدارة مركزية</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 "> مكافحة برامج الفدية</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl shadow-lg">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-300 "> حماية الهواتف الذكية</h3>
            ...
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl shadow-lg">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-300 "> حلول الشركات</h3>
                <ul class="text-gray-600 dark:text-gray-400 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl shadow-lg">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-300 "> الحماية السحابية</h3>
                <ul class="text-gray-600 dark:text-gray-400 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">كفاءة عالية</h3>
                <p class="text-gray-600 dark:text-gray-500">
...
<section class="py-16 bg-white dark:bg-slate-800">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-[#1a5a72] dark:text-[#1a5a72] mb-4"> خدمات إضافية</h2>
            <p class="text-gray-600 dark:text-gray-500 max-w-3xl mx-auto">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">شركاء مع أكبر الموردين</h3>
                    <p class="text-gray-600 dark:text-gray-500">
