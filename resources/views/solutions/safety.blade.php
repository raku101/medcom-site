    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">أنظمة إنذار الحريق المعتمدة</h3>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">معدات إطفاء الحرائق الذكية</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">مراقبة بيئة العمل</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">خوذ ذكية للعاملين</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
...
<section class="py-16 bg-white dark:bg-slate-800">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-[#1a5a72] dark:text-[#1a5a72] mb-4">مميزات أنظمة السلامة لدينا</h2>
            <p class="text-gray-600 dark:text-gray-500 max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="flex items-start bg-gray-50 dark:bg-slate-700 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">معتمدة رسمياً</h3>
            ...
            <div class="flex items-start bg-gray-50 dark:bg-slate-700 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">استجابة فورية</h3>
            ...
            <div class="flex items-start bg-gray-50 dark:bg-slate-700 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">مراقبة ذكية</h3>
            ...
            <div class="flex items-start bg-gray-50 dark:bg-slate-700 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">حماية شاملة</h3>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">المنشآت الصناعية</h3>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">المباني التجارية</h3>
                <p class="text-gray-600 dark:text-gray-500">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">المنشآت التعليمية</h3>
                <p class="text-gray-600 dark:text-gray-500">
                    مدارس - جامعات - معاهد
                </p>
            </div>
...
<section class="py-16 bg-white dark:bg-slate-800">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-[#1a5a72] dark:text-[#1a5a72] mb-4">لماذا تختار ميدكوم لحلول السلامة؟</h2>
            <p class="text-gray-600 dark:text-gray-500 max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">حلول معتمدة</h3>
                    <p class="text-gray-600 dark:text-gray-500">
