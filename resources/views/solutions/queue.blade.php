    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">جهاز سحب التذاكر</h3>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">شاشة عرض الأرقام</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">جهاز المناداة من قبل الموظف</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">نظام صوتي للنداء</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border-t-4 border-[#1a5a72]">
                ...
                <h3 class="font-bold text-xl mb-3 text-gray-800 dark:text-gray-600 ">طابعة تقارير وإحصائيات</h3>
                <ul class="text-gray-600 dark:text-gray-500 space-y-2">
                    <li class="flex items-start">
                        <span class="mr-2">•</span>
...
<section class="py-16 bg-white dark:bg-slate-800">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-[#1a5a72] dark:text-[#1a5a72] mb-4">استخدامات النظام في مختلف القطاعات</h2>
            <p class="text-gray-600 dark:text-gray-500 max-w-3xl mx-auto">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="flex items-start bg-white dark:bg-slate-800 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">ربط مع شاشات الخدمة الذاتية</h3>
                </div>
            </div>
            ...
            <div class="flex items-start bg-white dark:bg-slate-800 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">دعم النداء عبر تطبيق جوّال</h3>
                </div>
            </div>
            ...
            <div class="flex items-start bg-white dark:bg-slate-800 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">نظام تقييم رضا العميل</h3>
                </div>
            </div>
            ...
            <div class="flex items-start bg-white dark:bg-slate-800 p-4 rounded-lg shadow">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-500">تقارير إدارية مفصلة</h3>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-16 bg-white dark:bg-slate-800">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-[#1a5a72] dark:text-[#1a5a72] mb-4">الخدمات المقدمة</h2>
            <p class="text-gray-600 dark:text-gray-500 max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">التوريد والتركيب الكامل</h3>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">برمجة النظام وتخصيصه</h3>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">تدريب الموظفين</h3>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-slate-700 p-6 rounded-xl text-center">
                ...
                <h3 class="font-bold text-lg mb-2 text-gray-800 dark:text-gray-500">دعم فني وصيانة</h3>
            </div>
        </div>
    </div>
</section>
